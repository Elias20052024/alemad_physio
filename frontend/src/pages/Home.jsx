  ...
  const services = [
    {
      ...
      image: new URL('/public/Services images/Adult Physiotherapy Department.png', import.meta.url).href,
      color: '#1C6FB5',
      link: '/services',
    },
    {
      ...
      image: new URL('/public/Services images/Pediatric Physiotherapy Department.png', import.meta.url).href,
      color: '#CBDD71',
      link: '/services',
    },
    {
      ...
      image: new URL('/public/Services images/Intensive Physiotherapy Program.png', import.meta.url).href,
      color: '#74C3E7',
      link: '/services',
    },
  ];
